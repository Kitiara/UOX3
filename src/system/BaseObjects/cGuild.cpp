...
void CGuildCollection::GumpInput(CPIGumpInput *gi)
{
    ...
    switch(index)
    {
        case 1: // set guild name
            gList[trgGuild]->Name(text);
            break;
        case 2: // set guild abbreviation
            gList[trgGuild]->Abbreviation(text.c_str());
            break;
        case 3: // set guildmaster title
        ...
        case BasePage+1: // Main menu
            switch(button)
            {
                ...
                case 4:
                    ...
                    break;
                case 5: // declare fealty
                    s->target(2, 1, 157);
                    break;
                case 6: // toggle abbreviation
                    ToggleAbbreviation(s);
                    break;
                case 7: // Resign from guild
                    Resign(s);
                    break;
                case 8: // View candidates
                    Menu(s, BasePage + 6, trgGuild);
                    break;
                case 9: // View warring guilds
                    Menu(s, BasePage + 11, trgGuild);
                    break;
                case 10: // View guilds that declared war on us
                    Menu(s, BasePage + 15, trgGuild);
                    break;
                case 11: // View list of allied guilds
                    Menu(s, BasePage + 18, trgGuild);
                    break;
                case 12: // Access guildmaster functions
        ...
        case BasePage+2: // Guildmaster menu
            switch(button)
            {
                ...
                case 3: // set guild abbreviation
                    TextEntryGump(s, ser, 100, 2, 3,  159);
                    break;
                case 4: // set guild type
                    Menu(s, BasePage + 3, trgGuild);
                    break;
                case 5: // set guild charter
                    Menu(s, BasePage + 4, trgGuild);
                    break;
                case 6: // dismiss a member
                    Menu(s, BasePage + 8, trgGuild);
                    break;
                case 7:// declare war from menu
                    Menu(s, BasePage + 13, trgGuild);
                    break;
                case 8: // declare war from target
                    s->target(2, 2, 160);
                    break;
                case 9: // declare peaceV
                    Menu(s, BasePage + 14, trgGuild);
                    break;
                case 10: // declare ally from menu
                    Menu(s, BasePage + 19, trgGuild);
                    break;
                case 11: // declare ally from target
                    s->target(2, 3, 161);
                    break;
                case 12: // accept candidate seeking membership
                    Menu(s, BasePage + 10, trgGuild);
                    break;
                case 13: // refuse candidate seeking membership
                    Menu(s, BasePage + 9, trgGuild);
                    break;
                case 14: // set guild master's title
                    TextEntryGump(s, ser, 100, 3, 15,  162);
                    break;
                case 15: // grant title to another member
                    Menu(s, BasePage + 12, trgGuild);
                    break;
#if defined(_MSC_VER)
    #pragma note("Move guildstone functionality goes here")
#endif
                case 16: // move guildstone
                    break;
                case 17: // return to main menu
