    ...
    for (DFNTAGS tag = toApply->FirstTag(); !toApply->AtEndTags(); tag = toApply->NextTag())
    {
        ...
        switch(tag)
        {
            ...
            case DFNTAG_DECAY:
                ...
                break;
            case DFNTAG_DISPELLABLE:
                applyTo->SetDispellable(true);
                break;
            case DFNTAG_DISABLED:
                applyTo->SetDisabled(ndata != 0);
                break;
            ...
            case DFNTAG_GET:
            {
                ...
                break;
            case DFNTAG_HP:
                applyTo->SetHP(static_cast<SI16>(RandomNum(ndata, odata)));    break;
            ...
            case DFNTAG_LIGHTNING:
                ...
                break;
            case DFNTAG_MAXHP:
                applyTo->SetMaxHP(static_cast<SI16>(ndata));
                break;
            case DFNTAG_MOVABLE:
                applyTo->SetMovable(static_cast<SI08>(ndata));
                break;
            case DFNTAG_MORE:
                applyTo->SetTempVar(CITV_MORE, ndata);
                break;
            case DFNTAG_MORE2:
                break;
            case DFNTAG_MOREX:
                applyTo->SetTempVar(CITV_MOREX, ndata);
                break;
            case DFNTAG_MOREY:
                applyTo->SetTempVar(CITV_MOREY, ndata);
                break;
            case DFNTAG_MOREZ:
                applyTo->SetTempVar(CITV_MOREZ, ndata);
                break;
            case DFNTAG_NAME:
                applyTo->SetName(cdata);
                break;
            case DFNTAG_NAME2:
                applyTo->SetName2(cdata.c_str());
                break;
            case DFNTAG_NEWBIE:
            ...
            case DFNTAG_RACE:
                ...
                break;
            case DFNTAG_RESTOCK:
                applyTo->SetRestock(static_cast<UI16>(ndata));
                break;
            case DFNTAG_RAIN:
            ...
            case DFNTAG_TYPE:
                ...
                break;
            case DFNTAG_VISIBLE:
                applyTo->SetVisible((VisibleTypes)ndata);
                break;
            case DFNTAG_VALUE:
            ...
            case DFNTAG_WEIGHT:
                ...
                break;
            case DFNTAG_WEIGHTMAX:
                applyTo->SetWeightMax(ndata);
                break;
            case DFNTAG_WIPE:
            ...
            case DFNTAG_SPAWNOBJLIST:
                break;
            case DFNTAG_LOOT:
                Items->AddRespawnItem(applyTo, cdata, true, true);
                break;
            case DFNTAG_PACKITEM:
                ...
                break;
            default:
                Console.Warning("Unknown items dfn tag %i %s %i %i ", tag, cdata.c_str(), ndata, odata);
                break;
        }
    }
    return true;
