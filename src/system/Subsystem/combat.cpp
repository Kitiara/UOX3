...
void CHandleCombat::PlayerAttack(CSocket *s)
{
    ...
    if (ourChar->IsDead())
    {
        ...
        else if (cwmWorldState->ServerData()->PlayerPersecutionStatus())
        {
            ourChar->SetTarg(i);
            Skills->Persecute(s);
            return;
...
void CHandleCombat::CombatOnFoot(CChar *i)
{
    ...
    switch(getWeaponType(j))
    {
        ...
        case DUAL_SWORD:
        case ONEHND_AXES:
            animToPlay = (RandomNum(0, 1) ? 0x09 : 0x0A);
            break;
        case DEF_MACES:
            animToPlay = (RandomNum(0, 1) ? 0x09 : 0x0B);
            break;
        case LG_MACES:
        case TWOHND_LG_SWORDS:
        case BARDICHE:
        case TWOHND_AXES:
            animToPlay = (RandomNum(0, 1) ? 0x0C : 0x0D);
            break;
        case DUAL_FENCING_STAB:
        case DEF_FENCING:
            animToPlay = 0x0A;
    ...
    if (cwmWorldState->ServerData()->CombatDisplayHitMessage() && targSock != NULL)
    {
        ...
        switch(hitLoc)
        {
            ...
            case 2: // Arms
                ...
                {
                    case 1:
                        targSock->sysmessage(290, mChar->GetName().c_str());
                        break;
                    case 2:
                        targSock->sysmessage(291, mChar->GetName().c_str());
                        break;
                    default:
                        targSock->sysmessage(292, mChar->GetName().c_str());
                        break;
                }
                break;
            case 3: // Head
            ...
            case 4: // Legs
                ...
                {
                    case 1:
                        targSock->sysmessage(299, mChar->GetName().c_str());
                        break;
                    case 2:
                        targSock->sysmessage(300, mChar->GetName().c_str());
                        break;
                    default:
                        targSock->sysmessage(301, mChar->GetName().c_str());
                        break;
                }
                break;
            case 5: // Neck
            ...
            case 6: // Hands
                ...
                {
                    case 1:
                        targSock->sysmessage(303, mChar->GetName().c_str());
                        break;
                    case 2:
                        targSock->sysmessage(304, mChar->GetName().c_str());
                        break;
                    default:
                        targSock->sysmessage(305, mChar->GetName().c_str());
                        break;
                }
                break;
        }
        ...
        if (playerDistance < cwmWorldState->ServerData()->CombatMaxSpellRange())
        {
            ...
            switch((RandomNum(static_cast< SI16 >(0), spattacks) + 1))
            {
                case 1:
                    ...
                    break;
                case 2: // Harm
                    CastSpell(npcAttack, cDefend, 12);
                    break;
                case 3:
                ...
                case 8:
                    switch(RandomNum(1, 2))
                    {
                        ...
                        case 2:
                            break; //CastSpell(npcAttack, cDefend, 58);        break; // Energy Vortex
                    }
                    break;
...
R32 CHandleCombat::GetCombatTimeout(CChar *mChar)
{
    ...
    else if (mChar->GetSkill(WRESTLING) < 800)
