...
UString::UString(const std::string& str, std::string::size_type str_idx, std::string::size_type str_num) : stdstring(str,str_idx,str_num) {}
UString::UString(const char* cstr) : stdstring(cstr) {}
UString::UString(const char* chars, std::string::size_type chars_len) : stdstring(chars,chars_len) {}
