...
bool cAccountClass::TransCharacter(UI16 wSAccountID,UI16 wSSlot,UI16 wDAccountID)
{
    ...
    if (I==m_mapUsernameIDMap.end()) // This ID was not found.
        return false;
    ...
    if (J==m_mapUsernameMap.end()) // This ID was not found.
        return false;
    ...
    if (II == m_mapUsernameIDMap.end()) // This ID was not found.
        return false;
    ...
    if (JJ==m_mapUsernameMap.end()) // This ID was not found.
        return false;
    // Get the account block for this username.
...
bool cAccountClass::AddCharacter(UI16 wAccountID, UI16 wSAccountID, UI16 wSSlot, UI32 dwCharacterID, CChar *lpObject, bool transaction)
{
    ...
    if (IdItr == m_mapUsernameIDMap.end()) // This ID was not found.
        return false;
    ...
    if (NameItr == m_mapUsernameMap.end()) // This ID was not found.
        return false;
...
//o--------------------------------------------------------------------------o
//| Description  - Writes the Access.Adm header to the specified output stream.
//o--------------------------------------------------------------------------o
...
//o--------------------------------------------------------------------------o
//| Description  - Writes the Orphan.Adm header to the specified output stream.
//o--------------------------------------------------------------------------o
...
//o--------------------------------------------------------------------------o
//| Description  - Writes the Username.uad header to the specified output stream.
//o--------------------------------------------------------------------------o
