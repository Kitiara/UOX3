...
typedef std::tr1::unordered_map<std::string, CommandMapEntry> COMMANDMAP;
typedef std::tr1::unordered_map<std::string, TargetMapEntry> TARGETMAP;
typedef std::tr1::unordered_map<std::string, JSCommandEntry> JSCOMMANDMAP;
